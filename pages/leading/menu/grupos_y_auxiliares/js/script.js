...
const datosPrueba = [
    { idGrupo: 1, nombreGrupo: "EDIFICACIONES", vidaUtil: 40, deprecia: true, actualiza: true, observaciones: "" },
    { idGrupo: 2, nombreGrupo: "MUEBLES Y ENSERES DE OFICINA", vidaUtil: 10, deprecia: true, actualiza: true, observaciones: "" },
    { idGrupo: 3, nombreGrupo: "MAQUINARIA EN GENERAL", vidaUtil: 8, deprecia: true, actualiza: true, observaciones: "" },
    { idGrupo: 4, nombreGrupo: "EQUIPO MEDICO Y DE LABORATORIO", vidaUtil: 8, deprecia: true, actualiza: true, observaciones: "" },
    { idGrupo: 5, nombreGrupo: "EQUIPO DE COMUNICACIONES", vidaUtil: 5, deprecia: true, actualiza: true, observaciones: "" },
    { idGrupo: 6, nombreGrupo: "EQUIPO EDUCACIONAL Y RECREATIVO", vidaUtil: 8, deprecia: true, actualiza: true, observaciones: "" },
    { idGrupo: 7, nombreGrupo: "VEHICULOS AUTOMOTORES", vidaUtil: 5, deprecia: true, actualiza: true, observaciones: "" }
];
